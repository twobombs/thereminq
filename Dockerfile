...
RUN cd /qrack && mkdir _build && cd _build && cmake -DENABLE_COMPLEX8=ON -DENABLE_UINT32=ON -DENABLE_COMPLEX_X2=ON -DQBCAPPOW=5 -DENABLE_OCL_MEM_GUARDS=OFF .. && make all && make install
