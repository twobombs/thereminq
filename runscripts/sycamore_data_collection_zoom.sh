...
time ./benchmarks --optimal --single --max-qubits=54 --samples=100 --benchmark-depth=13 test_quantum_supremacy --measure-output=/var/log/qrack/"measured_sycamore53_13_35_$(date +%F_%R_%S).log" >> q0_35_13_zoom.csv
