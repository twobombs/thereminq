...
ThereminQ orchestrates a suite of best-of-class tools designed to control, extend and visualize data emanating from Quantum circuits using ELK, Tipsy and Jupyter on CUDA and OpenCL accelerators.
